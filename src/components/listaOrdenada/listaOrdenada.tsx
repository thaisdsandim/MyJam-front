            ...
            <SectionCard>
                ...
                <div className="aside">
                    ...
                    <div className="numberCircle">
                        <p><span className="number">1</span> É gratis</p>
                        </div>
                    </div>
                    ...
                    <div className="list-row">
                    <div className="numberCircle">   
                        <p><span className="number">2</span> No seu tempo</p>
                        </div>
                    </div>
                    ...
                    <div className="list-row">
                    <div className="numberCircle">
                        <p><span className="number">3</span> Porque faz sentido</p>
                        </div>
                    </div>
                    ...
                    <div className="list-row">
                    <div className="numberCircle">
                        <p><span className="number">4</span> Se quiser mais, temos</p>
                        </div>
                    </div>
