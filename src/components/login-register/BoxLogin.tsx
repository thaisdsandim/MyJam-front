...
const BoxLogin = () => {
  ...
  const [passeye, setPasseye] = useState<string>(
    "https://icongr.am/fontawesome/eye.svg?size=16&color=88898a"
  );
    ...
    <LoginBox>
      <div>
        ...
        <form>
            ...
            <img
              ...
              onClick={() => {
                if (hidePass === "password") {
                  setHidePass("text");
                  setPasseye(
                    "https://icongr.am/fontawesome/eye-slash.svg?size=16&color=88898a"
                  );
                } else {
          ...
          <Button onClick={handleLogin} type="submit" className="enter">
            Login
          </Button>
        </form>
      </div>
